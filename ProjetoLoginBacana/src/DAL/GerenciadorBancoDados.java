...
public class GerenciadorBancoDados {
    ...
    public boolean verificarLoginSenha(String login, String password) {
        ...
        String sql = "SELECT * from TB_LOGIN where login = ? and password = ? ";
    ...
    public Boolean salvarUsuarioBD(CadastroUsuarioModel novoUsuario) {
        ...
        String sql = "insert into TB_LOGIN (USER_NAME, EMAIL, LOGIN, PASSWORD, PERFIL_USER) values (?, ?, ?, ?, ?)";
        PreparedStatement pst = null;
        Connection connection = null;
    ...
    public ArrayList<CadastroUsuarioModel> filtragemUsuariosBD(String nome) {
        ...
        String sql = "SELECT * from TB_LOGIN WHERE USER_NAME like'%" + nome + "%' order by USER_NAME";
        PreparedStatement pst = null;
        ResultSet rs = null;
        Connection connection = null;
    ...
    public void deletarUsuarioBD(String id_user) {
        ...
        String sql = "delete from TB_LOGIN where ID_USER = ?";
        PreparedStatement pst = null;
        Connection connection = null;
        ...
        try {
            ...
            pst.executeUpdate();
            System.out.println("Register excluded with sucess!");
        } catch (Exception e) {
            e.printStackTrace();
            System.out.println("ERRO::OperBancoDados::deletarDados");
        } finally {
            try {
                if (pst != null) {
                    pst.close();
    ...
    //metodo para atualizar as informações do banco de dados
    public void alterarUsuariosBD(CadastroUsuarioModel usuarioAtualizado) {
        String sql = "update TB_LOGIN set USER_NAME = ?, EMAIL = ?, LOGIN = ?, PERFIL_USER = ? where ID_USER = ?";
        PreparedStatement pst = null;
        Connection connection = null;
        ...
        try {
            ...
            e.printStackTrace();
            System.out.println("ERRO::OperBancoDados::alterarUsuariosBD");
        } finally {
            try {
                if (pst != null) {
                    pst.close();
